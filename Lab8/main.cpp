...
const GLuint SHADOW_W = 3072;
const GLuint SHADOW_H = 3072;
...
//arrays
GLuint VBO, VAO, quadVAO, quadVBO, FBO;
...
int main()
{
	...
	GLuint heightMap = loadTexture("..\\resources\\HeightMap.jpg");
	//GLuint cat = loadTexture("..\\resources\\download.jfif");
